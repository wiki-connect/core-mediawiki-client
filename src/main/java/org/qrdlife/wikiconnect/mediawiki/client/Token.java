...
/**
 * A helper class for managing and retrieving tokens from the MediaWiki Action API.
 * <p>
 * MediaWiki requires tokens (e.g., login, CSRF) for certain write or authentication actions.
...
public class Token {
     ...
     *
     * @param requester The {@link Requester} instance used to communicate with the MediaWiki Action API.
     */
     ...
     *
     * @throws JSONException If the response cannot be parsed as JSON or the expected fields are missing.
     */
